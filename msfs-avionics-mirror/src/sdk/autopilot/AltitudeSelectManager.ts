import { NumberUnitInterface, UnitFamily, UnitType } from '../';
import { EventBus, KeyEventData, KeyEvents, KeyInterceptManager, SimVarValueType } from '../data';
import { APEvents } from '../instruments';
import { UserSettingType, UserSettingManager, UserSetting } from '../settings';
 ...
 */
export type MetricAltitudeSettingsManager = UserSettingManager<MetricAltitudeSelectSetting & Record<any, UserSettingType>>;
...
export class AltitudeSelectManager {
  ...
  private readonly altimeterMetricSetting: UserSetting<'altMetric', boolean> | undefined;
