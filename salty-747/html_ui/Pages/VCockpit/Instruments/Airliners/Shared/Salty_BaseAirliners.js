...
(function (Airliners) {
    ...
    (function (EICAS_INFO_PANEL_MESSAGE_STYLE) {
        EICAS_INFO_PANEL_MESSAGE_STYLE[EICAS_INFO_PANEL_MESSAGE_STYLE["MEMO"] = 0] = "MEMO";
        EICAS_INFO_PANEL_MESSAGE_STYLE[EICAS_INFO_PANEL_MESSAGE_STYLE["ADVISORY"] = 1] = "ADVISORY";
        EICAS_INFO_PANEL_MESSAGE_STYLE[EICAS_INFO_PANEL_MESSAGE_STYLE["CAUTION"] = 2] = "CAUTION";
        EICAS_INFO_PANEL_MESSAGE_STYLE[EICAS_INFO_PANEL_MESSAGE_STYLE["WARNING"] = 3] = "WARNING";
        EICAS_INFO_PANEL_MESSAGE_STYLE[EICAS_INFO_PANEL_MESSAGE_STYLE["TITLE"] = 4] = "TITLE";
        EICAS_INFO_PANEL_MESSAGE_STYLE[EICAS_INFO_PANEL_MESSAGE_STYLE["OPTION"] = 5] = "OPTION";
