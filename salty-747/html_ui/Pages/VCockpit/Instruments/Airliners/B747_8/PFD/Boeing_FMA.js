...
(function (Boeing_FMA) {
    ...
    class Column1Top extends Annunciation {
        ...
        getActiveMode() {
            ...
            if (Simplane.getEngineThrottleMode(0) === ThrottleMode.TOGA || (this.flagTOGA && (Simplane.getIndicatedSpeed() < 80 && Simplane.getIndicatedSpeed() > 65)) || (Simplane.getEngineThrottleMode(0) === ThrottleMode.CLIMB && Simplane.getCurrentFlightPhase() === FlightPhase.FLIGHT_PHASE_CLIMB)) {
                this.flagTOGA = true;
                return 4;
            }
