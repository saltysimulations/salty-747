class B747_8_FMC_DepArrIndexPage {
    static ShowPage1(fmc) {
        if (fmc.previousInput === "DEPARR") {
            B747_8_FMC_DepArrIndexPage.ShowIndexPage(fmc);
            return;
        }
        ...
        let directEntryPage = B747_8_FMC_DepArrIndexPage.ShowIndexPage;
        if (origin) {
            if (!airborne) {
                directEntryPage = B747_8_FMC_DepArrIndexPage.ShowDeparturePage;
            }
                ...
                if (distanceToOrigin > 50 || aircraftMovedMoreThanHalfwayToDestination) {
                    directEntryPage = B747_8_FMC_DepArrIndexPage.ShowArrivalPage;
                }
            }
        }
        directEntryPage(fmc);
    ...
    static ShowDeparturePage(fmc, currentPage = 1) {
        ...
        modStr = fmc.fpHasChanged ? "MOD " : "ACT ";
        ...
        fmc.onPrevPage = () => {
            if (currentPage > 1) {
                ...
                B747_8_FMC_DepArrIndexPage.ShowDeparturePage(fmc, pageCount);
            }
        };
        fmc.onNextPage = () => {
    ...
    static ShowArrivalPage(fmc, currentPage = 1) {
        ...
        fmc.onExecPage = () => {
            ...
            B747_8_FMC_DepArrIndexPage.ShowArrivalPage(fmc);
            fmc.refreshPageCallback = () => B747_8_FMC_DepArrIndexPage.ShowArrivalPage(fmc);
        };
        //end of CWB EXEC handling
        modStr = fmc.fpHasChanged ? "MOD" : "ACT";
        ...
        fmc.onPrevPage = () => {
            if (currentPage > 1) {
                ...
                B747_8_FMC_DepArrIndexPage.ShowArrivalPage(fmc, pageCount);
            }
        };
        fmc.onNextPage = () => {
            if (currentPage < pageCount) {
